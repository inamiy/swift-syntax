...
open class SyntaxVisitor {
  ...
  open func visit(_ node: IdentifierListSyntax) {
    visitChildren(node)
  }
  open func visit(_ node: OperatorPrecedenceAndTypesSyntax) {
    visitChildren(node)
  }
  ...
  open func visit(_ node: NamedAttributeStringArgumentSyntax) {
    visitChildren(node)
  }
  open func visit(_ node: DeclNameSyntax) {
    visitChildren(node)
  }
  ...
  open func visit(_ node: YieldListSyntax) {
    visitChildren(node)
  }
  ...
  open func visit(_ node: PoundAssertStmtSyntax) {
    visitChildren(node)
  }
  ...
  public func visit(_ node: Syntax) {
    ...
    case .identifierList: visit(node as! IdentifierListSyntax)
    case .operatorPrecedenceAndTypes: visit(node as! OperatorPrecedenceAndTypesSyntax)
    ...
    case .namedAttributeStringArgument: visit(node as! NamedAttributeStringArgumentSyntax)
    case .declName: visit(node as! DeclNameSyntax)
    ...
    case .yieldList: visit(node as! YieldListSyntax)
    ...
    case .poundAssertStmt: visit(node as! PoundAssertStmtSyntax)
