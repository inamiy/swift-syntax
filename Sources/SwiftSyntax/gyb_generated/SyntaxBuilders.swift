...
public struct KeyPathBaseExprSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .keyPathBaseExpr,
                                     layout: layout, presence: .present))
  }
}
...
public struct PoundSourceLocationSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .poundSourceLocation,
                                     layout: layout, presence: .present))
  }
}
...
public struct PoundSourceLocationArgsSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .poundSourceLocationArgs,
                                     layout: layout, presence: .present))
  }
}
...
public struct MemberDeclBlockSyntaxBuilder {
  ...
  public mutating func addMemberDeclListItem(_ elt: MemberDeclListItemSyntax) {
    ...
    if let list = layout[idx] {
      ...
      layout[idx] = RawSyntax(kind: SyntaxKind.memberDeclList,
                              layout: [elt.raw],
                              presence: SourcePresence.present)
    }
  }
...
public struct MemberDeclListItemSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .memberDeclListItem,
                                     layout: layout, presence: .present))
  }
}
...
public struct AccessorBlockSyntaxBuilder {
  ...
  public mutating func addAccessorDecl(_ elt: AccessorDeclSyntax) {
    let idx = AccessorBlockSyntax.Cursor.accessors.rawValue
    if let list = layout[idx] {
      layout[idx] = list.appending(elt.raw)
    } else {
      layout[idx] = RawSyntax(kind: SyntaxKind.accessorList,
                              layout: [elt.raw],
                              presence: SourcePresence.present)
    }
  }
...
public struct OperatorPrecedenceAndTypesSyntaxBuilder {
  ...
  public mutating func addIdentifierToken(_ elt: TokenSyntax) {
    let idx = OperatorPrecedenceAndTypesSyntax.Cursor.precedenceGroupAndDesignatedTypes.rawValue
    if let list = layout[idx] {
      layout[idx] = list.appending(elt.raw)
    } else {
      layout[idx] = RawSyntax(kind: SyntaxKind.identifierList,
                              layout: [elt.raw],
                              presence: SourcePresence.present)
    }
  }
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .operatorPrecedenceAndTypes,
                                     layout: layout, presence: .present))
  }
}
...
public struct LabeledSpecializeEntrySyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .labeledSpecializeEntry,
                                     layout: layout, presence: .present))
  }
}
...
public struct NamedAttributeStringArgumentSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .namedAttributeStringArgument,
                                     layout: layout, presence: .present))
  }
}
...
public struct DeclNameSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .declName,
                                     layout: layout, presence: .present))
  }
}
...
public struct ImplementsAttributeArgumentsSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .implementsAttributeArguments,
                                     layout: layout, presence: .present))
  }
}
...
public struct ObjCSelectorPieceSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .objCSelectorPiece,
                                     layout: layout, presence: .present))
  }
}
...
public struct YieldStmtSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .yieldStmt,
                                     layout: layout, presence: .present))
  }
}
...
public struct YieldListSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .yieldList,
                                     layout: layout, presence: .present))
  }
}
...
public struct AvailabilityConditionSyntaxBuilder {
  ...
  public mutating func addAvailabilityArgument(_ elt: AvailabilityArgumentSyntax) {
    ...
    if let list = layout[idx] {
      ...
      layout[idx] = RawSyntax(kind: SyntaxKind.availabilitySpecList,
                              layout: [elt.raw],
                              presence: SourcePresence.present)
    }
  }
...
public struct PoundAssertStmtSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .poundAssertStmt,
                                     layout: layout, presence: .present))
  }
}
...
public struct ClassRestrictionTypeSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .classRestrictionType,
                                     layout: layout, presence: .present))
  }
}
...
public struct AvailabilityArgumentSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .availabilityArgument,
                                     layout: layout, presence: .present))
  }
}
...
public struct AvailabilityLabeledArgumentSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .availabilityLabeledArgument,
                                     layout: layout, presence: .present))
  }
}
...
public struct AvailabilityVersionRestrictionSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .availabilityVersionRestriction,
                                     layout: layout, presence: .present))
  }
}
...
public struct VersionTupleSyntaxBuilder {
  ...
  internal mutating func buildData() -> SyntaxData {
    ...
    return SyntaxData(raw: RawSyntax(kind: .versionTuple,
                                     layout: layout, presence: .present))
  }
}
